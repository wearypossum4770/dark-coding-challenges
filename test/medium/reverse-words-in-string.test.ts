...
import { reverseWordsInString } from "@/src/medium/reverse-words-in-string";
...
describe("reverseWordsInString", () => {
	...
	])("\n\tGiven: the string %s.\n\tThen: reversed it is %s.", (inputs: string, expected: string) => {
		const result = reverseWordsInString(inputs);
