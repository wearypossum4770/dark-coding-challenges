...
import { smallestTrimmedNumbers } from "@/src/medium/smallest-trimmed-numbers";
describe("\n\tFeature: Smallest Trimmed Numbers", () => {
	test.each([
		...
		[
			["000...001", "000...002", "000...010", "000...100"],
			[
				[1, 100],
				[2, 100],
				[3, 100],
		...
		[
			Array(50).fill("000...000").concat(Array(50).fill("999...999")),
			[
				[25, 100],
				[50, 100],
				[75, 100],
		...
		[
			["00000000000000000001", "00000000000000000010", "00000000000000000100"],
			[
				[1, 20],
				[2, 20],
				[3, 20],
	...
	])("\n\tGiven: the numbers %p and queries %p.\n\tThen: the indices are %p", (nums: string[], queries: number[][], expected: number[]) => {
