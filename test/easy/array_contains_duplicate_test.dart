// dart format width=500  // Override formatter width for this file only; keeps array "shrunk"

import 'package:test/test.dart';
import 'package:dark_coding_challenges/easy/array_contains_duplicate.dart';

class ArrayContainsDuplicateTestCases {
  List<int> nums;
  bool expected;
  ArrayContainsDuplicateTestCases(this.nums, this.expected);
}

void main() {
  group("Feature:", () {
    final testCases = [
      ArrayContainsDuplicateTestCases([1, 2, 3, 1], true),
      ArrayContainsDuplicateTestCases([1, 2, 3, 4], false),
      ArrayContainsDuplicateTestCases([1, 1, 1, 3, 3, 4, 3, 2, 4, 2], true),
      ArrayContainsDuplicateTestCases([1, 3, 4, 2, 2], true),
      ArrayContainsDuplicateTestCases([3, 4, 1, 4, 2], true),
      ArrayContainsDuplicateTestCases([3, 1, 3, 4, 2], true),
      ArrayContainsDuplicateTestCases([2, 1, 2], true),
      ArrayContainsDuplicateTestCases([1, 5, 3, 4, 2, 5], true),
      ArrayContainsDuplicateTestCases([1, 2, 3], false),
      ArrayContainsDuplicateTestCases([3, 4, 1, 4, 1], true),
      ArrayContainsDuplicateTestCases(
    ...
    for (final step in testCases) {
      ...
      test("\n\tGiven: the array $nums.\n\tThen: it has duplicate elements $expected", () {
        bool result = arrayContainsDuplicate(nums);
