...
public class LeafCountInBinaryTreeTests
{
    public static TheoryData<int?[], int> LeafCountInBinaryTreeData =>
        new()
        {
            { [1, 10, 39, 5], 2 },
            ...
            { [50, 30, 70, 20, 40, 60, 80, null, null, null, null, null, null, null, null], 4 },
            // // Difficult / degenerate cases
            { [1, 2, null, 3, null, 4, null, 5, null, 6, null, 7, null, 8, null, 9, null, 10], 1 },
            ...
            { [1, 2, 3, null, null, null, 4, null, null, null, null, null, null, null, 5], 2 },
            { [99999, null, null], 1 },
        };

    [Theory]
    [MemberData(nameof(LeafCountInBinaryTreeData))]
    public void ShouldLeafCountInBinaryTree(int?[] input, int expected)
    {
        var instance = new LeafCountInBinaryTree();
        var root = TreeNode.FromIntegerList(input);
