...
class KodeeReformatDateTest {
@ParameterizedTest
@MethodSource("reformatDateData")
fun kodeeReformatDateTest(
date:String,
expected:String,
) {
val result = kodeeReformatDate(date)
assertEquals(expected, result)
}
companion object {
@JvmStatic
fun reformatDateData(): Stream<Arguments> =
Stream.of(
