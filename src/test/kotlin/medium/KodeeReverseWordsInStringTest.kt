...
class KodeeReverseWordsInStringTest {
    @ParameterizedTest
    @MethodSource("reverseWordsInStringData")
    fun kodeeReverseWordsInStringTest(
        s: String,
        expected: String,
    ) {
        val result = kodeeReverseWordsInString(s)
        assertEquals(expected, result)
    }

    companion object {
        @JvmStatic
        fun reverseWordsInStringData(): Stream<Arguments> =
            Stream.of(
                ...
                Arguments.of("foo bar baz qux quux corge grault garply waldo fred", "fred waldo garply grault corge quux qux baz bar foo"),
                ...
                Arguments.of("z y x w v u t s r q p o n m l k j i h g f e d c b a", "a b c d e f g h i j k l m n o p q r s t u v w x y z"),
                Arguments.of(
