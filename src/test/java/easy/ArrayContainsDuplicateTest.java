...
public class ArrayContainsDuplicateTest {
  ArrayContainsDuplicate instance = new ArrayContainsDuplicate();

  @ParameterizedTest
  @MethodSource("dataArrayContainsDuplicate")
  public void testArrayContainsDuplicate(int[] nums, boolean expected) {

    boolean actual = instance.solve(nums);

    assertEquals(expected, actual);
  }

  public static Stream<Arguments> dataArrayContainsDuplicate() {
    return Stream.of(
        Arguments.of(new int[] {1, 2, 3, 1}, true),
        Arguments.of(new int[] {1, 2, 3, 4}, false),
        Arguments.of(new int[] {1, 1, 1, 3, 3, 4, 3, 2, 4, 2}, true),
        Arguments.of(new int[] {1, 3, 4, 2, 2}, true),
        Arguments.of(new int[] {3, 4, 1, 4, 2}, true),
        Arguments.of(new int[] {3, 1, 3, 4, 2}, true),
        Arguments.of(new int[] {2, 1, 2}, true),
        Arguments.of(new int[] {1, 5, 3, 4, 2, 5}, true),
        Arguments.of(new int[] {1, 2, 3}, false),
        Arguments.of(new int[] {3, 4, 1, 4, 1}, true),
        Arguments.of(
            new int[] {
              // spotless:off
