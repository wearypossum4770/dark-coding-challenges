...
public class IsSameTreeTest {
  IsSameTree<Integer> instance = new IsSameTree<>();

  @ParameterizedTest
  @MethodSource("algoMonsterData")
  public void algoMonsterTest(String a, String b, boolean expected) {
    TreeNode<Integer> p = TreeNode.fromString(a);
    TreeNode<Integer> q = TreeNode.fromString(b);
    boolean result = instance.solve(p, q);

    assertEquals(expected, result);
  }

  public static Stream<Arguments> algoMonsterData() {
    return Stream.of(
