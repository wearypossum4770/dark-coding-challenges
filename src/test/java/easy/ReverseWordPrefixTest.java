...
public class ReverseWordPrefixTest {
  ReverseWordPrefix instance = new ReverseWordPrefix();

  @ParameterizedTest
  @MethodSource("dataReverseWordPrefix")
  public void testReverseWordPrefix(String word, char c, String expected) {

    String result = instance.solve(word, c);

    assertEquals(expected, result);
  }

  public static Stream<Arguments> dataReverseWordPrefix() {
    return Stream.of(
