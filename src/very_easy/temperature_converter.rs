...
pub fn convert_temperature(celsius: f64) -> Vec<f64> {
    Vec::from([to_kelvin(celsius), to_fahrenheit(celsius)])
}
#[cfg(test)]
mod tests {
    use super::{
        convert_temperature, temperature_converter, to_celsius, to_fahrenheit, to_kelvin, tolerance,
    };
    use rstest::rstest;
    #[rstest]
    #[case("35°C", "95°F")]
