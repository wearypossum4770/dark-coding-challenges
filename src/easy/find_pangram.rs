...
mod tests {
    ...
    assert_eq!(hacker_rank_pangram("We promptly judged antique ivory buckles for the next prize"),  "pangram" );
    assert_eq!(hacker_rank_pangram("We promptly judged antique ivory buckles for the prize"),  "not pangram");
    }
    #[test]
